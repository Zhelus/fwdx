...
<template>
  <div style="display: flex; flex-direction: column;">
    ...
    <p>To get started, make sure both the frontend and backend are running locally on your machine. You can check the log output in Flask to ensure a 200 was returned.</p>
